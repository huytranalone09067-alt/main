...
-- Update thông tin thời gian thực
task.spawn(function()
...
Tabs.Library:AddToggle("LibraryBookESP", { Title = "ESP LiveHintBook", Default = false })
Tabs.Library:AddColorpicker("LibBookColor", { Title = "Book Color", Default = Color3.fromRGB(255, 0, 255) })
                        ...
                        if parent then
                            ...
                            if shouldLoot then
                                ...
                                if dist <= prompt.MaxActivationDistance then
                                    ...
                                    prompt.HoldDuration = 0 -- Bypass hold time to auto interact instantly
